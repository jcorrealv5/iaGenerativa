anime_path = r"C:\Data\Python\2026_01_IAG\Demos\datasets\Animes"
...
def main():
    print("Demo 31: DC-GAN para Entrenar Caras de Animes")
    ...
    for i in range(epocas):
        ...
        archivo = "preentrenados/GAN/Animes/GAN_Animes_" + str(i+1) + "_" + str(G_perdida_valor) + ".pt"
