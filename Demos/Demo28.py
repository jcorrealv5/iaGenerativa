...
def main():
    ...
    batch_size = 64
    epocas = 10
    loader_train = torch.utils.data.DataLoader(X_train, batch_size=batch_size, shuffle=True, num_workers=12, pin_memory=True, persistent_workers=True)
    ...
    print(f"La perdida minima fue: {minPerdida} en la Epoca: {minEpoca}")
