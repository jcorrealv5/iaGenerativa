...
def train_mnist(n_epoch: int = 100, device="cuda:0") -> None:
    ...
    dataset = MNIST("datasets/MINIST",train=True,download=True,transform=tf,)
    ...
    for i in range(n_epoch):
        ...
        with torch.no_grad():
            ...
            save_image(grid, "preentrenados/DM/DM00/ddpm_sample_{i}.png")
            torch.save(ddpm.state_dict(), "preentrenados/DM/DM00.pth")
