...
print("Demo 81: Usando denoising_diffusion_pytorch para generar ruido desde un Modelo Personalizado")
...
checkpoint = torch.load('/Users/jhon.correal/Documents/Python/Shifu/preentrenados/DM/Demo80.pth', map_location=device)
...
save_image(sampled_images, "Demo80_Imagenes.png", nrow=2, normalize=True)
