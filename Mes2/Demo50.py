...
print("Demo 50: Entrenamiento de un Modelo Cycle-GAN de CelebA para Pelos")
...
def test(i,A,B,fake_A,fake_B):
    save_image(A*0.5+0.5,f"preentrenados/GAN/Pelos/A{i}.png")
    save_image(B*0.5+0.5,f"preentrenados/GAN/Pelos/B{i}.png")
    save_image(fake_A*0.5+0.5,f"preentrenados/GAN/Pelos/fakeA{i}.png")
    save_image(fake_B*0.5+0.5,f"preentrenados/GAN/Pelos/fakeB{i}.png")
...
torch.save(gen_A.state_dict(), "preentrenados/GAN/Pelos/gen_black.pth")
torch.save(gen_B.state_dict(), "preentrenados/GAN/Pelos/gen_blond.pth")

horaFin = datetime.now()
tiempoSeg = (horaFin - horaInicio).total_seconds()
print(f"Se creo y entreno el Modelo cGAN de Caras en {tiempoSeg} seg")