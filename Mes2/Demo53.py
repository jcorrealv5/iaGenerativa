...
print("Demo 53: Entrenamiento de un Modelo Cycle-GAN de CelebA para Sexo")
...
def test(epoca,i,A,B,fake_A,fake_B):
    carpeta = "C:/Data/Python/2026_01_IAG/Demos/preentrenados/GAN/Sexo/Epoca" + str(epoca)
...
for epoca in range(10):
    ...
    torch.save(gen_A.state_dict(), "preentrenados/GAN/Sexo/gen_mujer_" + str(epoca+1) + ".pth")
    torch.save(gen_B.state_dict(), "preentrenados/GAN/Sexo/gen_hombre_" + str(epoca+1) + ".pth")
torch.save(gen_A.state_dict(), "preentrenados/GAN/Sexo/gen_mujer.pth")
torch.save(gen_B.state_dict(), "preentrenados/GAN/Sexo/gen_hombre.pth")
