...
print("Demo 55: Prueba del Modelo CycleGAN de Sexo")
...
dataset = LoadData(root_A=["datasets/SexTest/Femenino/"],root_B=["datasets/SexTest/Masculino/"],transform=transforms)
...
print("2. Generando Caras con Hombres y Mujeres")
